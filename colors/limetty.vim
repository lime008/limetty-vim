...
" limetty-vim (https://github.com/chriskempson/limetty-vim)
" by Chris Kempson (http://chriskempson.com)
" Limetty scheme by lime008 (https://github.com/lime008)

" This enables the coresponding limetty-shell script to run so that
" :colorscheme works in terminals supported by limetty-shell scripts
...
hi clear
syntax reset
let g:colors_name = "limetty"

" Highlighting function
" Optional variables are attributes and guisp
function! s:limettyhi(group, guifg, guibg, ctermfg, ctermbg, ...)
  let l:attr = get(a:, 1, "")
  let l:guisp = get(a:, 2, "")
...
fun <sid>hi(group, guifg, guibg, ctermfg, ctermbg, attr, guisp)
  call s:limettyhi(a:group, a:guifg, a:guibg, a:ctermfg, a:ctermbg, a:attr, a:guisp)
endfun
